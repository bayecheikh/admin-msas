  ...
  export default {
    ...
    methods: {
      ...
      submitLigne () {
        ...
        console.log('SOurce Benef ++++++++ ,',this.selectedstructuresources)
        ...
        this.LigneFinancementInputs.push({
          id:this.counterrow,
          structure_source:this.selectedStructureSources0,
          structure_beneficiaire:this.selectedStructureBeneficiaires0,
